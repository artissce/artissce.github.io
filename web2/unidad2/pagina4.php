          ...
          <div class="s-12 l-10">
            <div class="top-nav right">
              ...
              <ul class="right chevron">
                ...
                <li><a href="./pagina1-2.php">Anterior</a></li>
        ...
        <article>
          <header class="section-top-padding background-white">
            <div class="line text-center">        
              <h1 class="text-dark text-s-size-30 text-m-size-40 text-l-size-headline text-thin text-line-height-1">Saludo con PHP</h1>
            </div>  
          </header>
