        ...
        <article>
          <header class="section-top-padding background-white">
            <div class="line text-center">        
              <h1 class="text-dark text-s-size-30 text-m-size-40 text-l-size-headline text-thin text-line-height-1">Array asociativa</h1>
            </div>  
          </header>
          <section class="section background-white">
            <div class="s-12 m-12 l-4 center">
            <?php 
$capital['SLP']= " San Luis Potosí ";
$capital['NL']= " Monterrey ";
$capital['NAY']= " Tepic ";
echo "La capital de Nuevo León es:".$capital['NL'];
?>
            </div>           
          </section> 
