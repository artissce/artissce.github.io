...
<html lang="en-US">
  <head>
    ...
    <title>Array asociativa con edades</title>
        ...
        <article>
          <header class="section-top-padding background-white">
            <div class="line text-center">        
              <h1 class="text-dark text-s-size-30 text-m-size-40 text-l-size-headline text-thin text-line-height-1">Array asociativa con edades</h1>
            </div>  
          </header>
          <section class="section background-white">
            <div class="s-12 m-12 l-4 center">
            <?php
$age = array("Joel"=>"20", "Ana"=>"18", "Mau"=>"19");
echo "Ana tiene " . $age['Ana'] . " años.";
?>
            </div>           
          </section> 
