        ...
        <article>
          <header class="section-top-padding background-white">
            <div class="line text-center">        
              <h1 class="text-dark text-s-size-30 text-m-size-40 text-l-size-headline text-thin text-line-height-1">Salto de linea</h1>
            </div>  
          </header>
          <section class="section background-white">
            <div class="s-12 m-12 l-4 center">
            <?php
	echo " <h2>Learn PHP</h2>Study PHP at W3Schools.com<br>9    <br><br>>";
	echo  "Aprendamos PHP \n 2020";
?>
            </div>           
          </section> 
